                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "20px" }}>
                            ...
                            <div style={{ flex: 1, background: "rgba(255,255,255,0.06)", borderRadius: "6px", padding: "6px 12px", fontSize: "12px", color: "rgba(255,255,255,0.6)", marginLeft: "8px" }}>
                                dashboard url
                            </div>
                        </div>
                            ...
                            <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: "12px", padding: "16px", display: "flex", flexDirection: "column", gap: "8px" }}>
                                ...
                                {["Dashboard", "Candidates", "Jobs", "Cost", "Trends"].map((item, i) => (
                                    <div key={item} style={{
                                        ...
                                        color: i === 0 ? "#3b82f6" : "rgba(255,255,255,0.7)",
                                    }}>{item}</div>
                                ))}
                            </div>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px" }}>
                                    {[
                                        ...
                                        <div key={kpi.label} style={{ background: "rgba(255,255,255,0.04)", borderRadius: "10px", padding: "12px" }}>
                                            ...
                                            <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.7)", marginTop: "2px" }}>{kpi.label}</div>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", flex: 1 }}>
                                    ...
                                    <div style={{ background: "rgba(255,255,255,0.04)", borderRadius: "10px", padding: "12px" }}>
                                        <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.7)", marginBottom: "12px" }}>Monthly Trends</div>
                                    ...
                                    {/* Funnel */}
                                    <div style={{ background: "rgba(255,255,255,0.04)", borderRadius: "10px", padding: "12px" }}>
                                        <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.7)", marginBottom: "12px" }}>Hiring Funnel</div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "32px" }}>
                        {[
                            ...
                            <div key={i} {...anim(`step-${i}`, i * 150)} style={{ ...anim(`step-${i}`, i * 150).style, position: "relative" }}>
                                ...
                                <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.7, margin: 0 }}>{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
                        {testimonials.map((t, i) => (
                            <div key={i} {...anim(`test-${i}`, i * 100)} style={{
                                ...
                                <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.8)", lineHeight: 1.7, margin: "0 0 24px", fontStyle: "italic" }}>
                                    "{t.text}"
                                </p>
                                <div>
                                    <div style={{ fontSize: "14px", fontWeight: 600, color: "#fff" }}>{t.name}</div>
                                    <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.7)", marginTop: "2px" }}>{t.role}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
                    <div {...anim("cta")} style={anim("cta").style}>
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: "17px", color: "rgba(255,255,255,0.7)", margin: "0 0 40px", lineHeight: 1.7 }}>
            ...
            <footer style={{
                ...
                <div style={{ display: "flex", gap: "24px" }}>
                    {["Privacy", "Terms", "Contact"].map(item => (
                        <a key={item} href="#" style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", textDecoration: "none", transition: "color 0.2s" }}
                            onMouseEnter={e => (e.currentTarget.style.color = "#fff")}
                            onMouseLeave={e => (e.currentTarget.style.color = "rgba(255,255,255,0.6)")}
                        >
                            {item}
